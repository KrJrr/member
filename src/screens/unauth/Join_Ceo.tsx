...
type Props = {
    navigation: StackNavigationProp<UnauthParamList, 'Join_Ceo'>
}

const Join_Ceo: FC<Props> = ({ navigation }) => {
    ...
    const [chkCo, setChkCo] = useState(false)
    ...
    }, [co_name, username, temporaryAccount.address, phoneNumber, certificationCode])
    ...
    return (
        ...
        >
            ...
            <Base.TextInput
                ...
                value={co_name}
                onChangeText={setCo_name}
                style={styles.textinput}
                placeholderTextColor={Color.PLACEHOLDER}
                maxLength={100}
            />
            {chkCo &&
                <Base.Text style={{ color: 'red', paddingHorizontal: 20 }} >회사/점포명을 입력해주세요.</Base.Text>
            }
            <Base.TextInput
                placeholder='대표자명'
                onBlur={() => {
            ...
            />
            {chkName &&
                <Base.Text style={{ color: 'red', paddingHorizontal: 20 }} >대표자명을 입력해주세요.</Base.Text>
            }
            <Base.Button
                style={styles.Button}
                onPress={() => {
